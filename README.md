...
The live site at **https://www.studiely.com** serves the Next.js marketing export at the root (`/`, `/blog`, `/pricing`, …) and the Flutter web app under **`/app/`** (`/app`, `/app/notes`, `/app/library`, …) from a single Firebase Hosting project (`studiely-c2ecc`).
...
For **Hostinger VPS** (Nginx, Let’s Encrypt, branch `web-hosting-and-urls`), use [vps-hosting/README.md](vps-hosting/README.md).
